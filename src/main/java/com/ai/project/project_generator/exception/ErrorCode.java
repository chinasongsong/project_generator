package com.ai.project.project_generator.exception;

import lombok.Getter;


/**
 * Getter不生效的话，要在设置里Build -- Compiler -- Annotation Processors -- 勾选 Enable annotation processing 和 Obtain processors from project classpath
 */
@Getter
