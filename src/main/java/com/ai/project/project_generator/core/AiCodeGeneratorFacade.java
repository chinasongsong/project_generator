...
import com.ai.project.project_generator.core.parser.CodeParser;
import com.ai.project.project_generator.core.saver.CodeFileSaver;
...
public class AiCodeGeneratorFacade {
    ...
    public File generateHtmlCode(String userMessage) {
        HtmlCodeResult htmlCodeResult = aiCodeGeneratorService.generateHtmlCode(userMessage);
        return CodeFileSaver.saveHtmlCodeResult(htmlCodeResult);
    }

    public File generateMultiFileCode(String userMessage) {
        MultiFileCodeResult multiFileCode = aiCodeGeneratorService.generateMultiFileCode(userMessage);
        return CodeFileSaver.saveMultiFileCodeResult(multiFileCode);
    }
